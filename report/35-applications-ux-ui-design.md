...
![mobile_login](../assets/img/mobile-wireframes/login.png)
...
![mobile_dashboard](../assets/img/mobile-wireframes/dashboard1.png)
...
![mobile_plantations](../assets/img/mobile-wireframes/parcela.png)
...
![details](../assets/img/mobile-wireframes/detalles-parcela.png)
...
![warnings](../assets/img/mobile-wireframes/alertas.png)
...
![sensors](../assets/img/mobile-wireframes/sensores.png)
...
![reports](../assets/img/mobile-wireframes/reportes.png)
...
![profile](../assets/img/mobile-wireframes/perfil.png)
...
![alertas](../assets/img/mobile-wireflows/alertas.png)
...
![recomendaciones](../assets/img/mobile-wireflows/recomendaciones.png)
...
![login](../assets/img/mobile-mockups/login.png)
...
![mobile_dashboard](../assets/img/mobile-mockups/dashboard.png)
...
![mobile_plantations](../assets/img/mobile-mockups/parcelas.png)
...
![details](../assets/img/mobile-mockups/detalles.png)

##### Warnings

Pantalla de alertas activas por plantación, con nivel de severidad, fecha de detección y estado de atención. Permite al usuario consultar el detalle de cada alerta y las recomendaciones asociadas para su atención.

![warnings](../assets/img/mobile-mockups/alertas.png)
...
![sensors](../assets/img/mobile-mockups/sensores.png)
...
![reports](../assets/img/mobile-mockups/reportes.png)
...
![profile](../assets/img/mobile-mockups/perfil.png)
...
![login](../assets/img/mobile-userflows/login.png)
...
![detalles](../assets/img/mobile-userflows/detalles.png)
...
![sensors](../assets/img/mobile-userflows/sensores.png)
