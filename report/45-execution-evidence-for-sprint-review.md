...
El Sprint 2 dejó tres artefactos ejecutables: Landing Page, Web Application, Mock API, Web Services, Embedded App y Edge Services.
...
| Web Services | Servicio desplegado para entregar datos a la Web Application.                                                                                            |
| Edge Services | Servicio desplegado para entregar datos al Web Services.                                                                                                 |
| Embedded App | Prototipo funcional.                                                                                                                                     |
