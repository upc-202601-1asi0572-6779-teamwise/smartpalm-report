...
![alt text](../assets/img/deploy-evidence/landing-desplegada.png)
...
![alt text](../assets/img/deploy-evidence/embedded-sensores.png)
...
![alt text](../assets/img/deploy-evidence/embedded-node.png)
...
![alt text](../assets/img/deploy-evidence/edge-api.png)
